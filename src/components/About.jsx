...
export const About = () => {
    return (
        <section id="about" className="py-32 bg-white dark:bg-black text-gray-900 dark:text-white relative leading-relaxed overflow-hidden transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
                ...
                <div className="space-y-12">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-500 dark:text-gray-500">
                            Engineering the Future.
                        </h2>
                    </motion.div>

                    <div className="space-y-8 text-xl md:text-2xl font-medium leading-relaxed text-gray-700 dark:text-gray-200">
                        <StaggeredParagraph
                    ...
                    >
                        <div className="px-8 py-6 bg-gray-100 dark:bg-white/5 rounded-3xl border border-black/5 dark:border-white/10 text-center hover:bg-gray-200 dark:hover:bg-white/10 transition-all hover:scale-105 duration-300">
                            <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">5+</div>
                            <div className="text-sm text-gray-600 dark:text-gray-500 uppercase tracking-wider font-semibold">AI Models</div>
                        </div>
                        <div className="px-8 py-6 bg-gray-100 dark:bg-white/5 rounded-3xl border border-black/5 dark:border-white/10 text-center hover:bg-gray-200 dark:hover:bg-white/10 transition-all hover:scale-105 duration-300">
                            <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">10+</div>
                            <div className="text-sm text-gray-600 dark:text-gray-500 uppercase tracking-wider font-semibold">Projects</div>
                        </div>
                    </motion.div>
                </div>
